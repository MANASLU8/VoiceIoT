...
TMP_TRAIN_FILE = 'cv/tmp_train.csv'
TMP_TEST_FILE = 'cv/tmp_test.json'
...
for i in range(len(sets)):
	...
	fo.write_lines(TMP_TRAIN_FILE.split('.')[0]+f'_{i}.'+TMP_TRAIN_FILE.split('.')[1], train_dataset)
	fo.write_json(TMP_TEST_FILE.split('.')[0]+f'_{i}.'+TMP_TEST_FILE.split('.')[1], test_dataset)
