...
intent_dataset = ATIS(train_file='../../dataset/slots-intents/train.csv', test_file='../../dataset/slots-intents/validate.csv', sentence_length=50, word_length=12)
...
vec_dimensions = 100
wvectors = wordvectors('../../vendor/word-vectors/poincare.txt')
...
machinelearning_model.save("../../models/slots-intents/model.h5")
with open("../../dataset/slots-intents/dataset_info", 'wb') as f:
