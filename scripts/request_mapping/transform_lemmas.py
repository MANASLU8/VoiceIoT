...
on_commands = ['', 'врубить', 'устанавливать', 'погреть', 'подсветить', 'проветрить', 'постирать', 'испечь', 'поставить', 'свари', 'разбудить',
				...
				"сделай громче", "громче", "увеличивать", "проигрывать", "воспроизводить", "сделай", "вари", "сделай кофе", "сделать", "громко", "кофе", "варить", "варя"]
off_commands = ['выключать', 'закрыть', 'оффнуть', 'остановить', 'прекратить', 'вырубить', 'прекрати', 'оффни', 'выруби', 'закрой', 'останови', "тише", "уменьшать", "сделай тише", "тихо"]
