...
data = fo.read_lines(config['paths']['datasets']['pytext']['data'])
...
fo.write_lines(config['paths']['datasets']['pytext']['validate'], validate_samples)
fo.write_json(config['paths']['datasets']['pytext']['test'], test_samples)
